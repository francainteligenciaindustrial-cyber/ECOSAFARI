...
export default function ImageUploadButton({ onUploaded, label = "Enviar imagem" }: { onUploaded: (url: string) => void; label?: string }) {
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-[11px] font-semibold text-emerald-700 border border-emerald-600/40 hover:bg-emerald-50 disabled:opacity-60 px-2.5 py-1.5 rounded-md transition cursor-pointer flex-shrink-0"
      >
